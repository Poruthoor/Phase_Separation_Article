'''
Usage :
    python3 plot_fluxProfile.py --suffix foo --temp_file tempList.dat --dat_files
    ClusterLipids2Total/DPPC_DAPC_CHOL/*K/1/Analysis/interval_avg/*flux*.dat
...
plt.savefig("flux_profile_" + args.suffix + "_" + args.temp + ".png")
