...
Some shape to initial blobs - Need to fix the referencing issue in Introduction section: 

Interactions among biomolecules often result in phase separation and subsequent formation of biological condensates32.
In the past decade, there has been a new appreciation for the role of phase separation in cell physiology1. Biological condensates involving fundamental biomolecules like DNA33, RNA34, protein35, and lipids8 are identified, and their functional roles are characterized.
Biological condensates have been observed to be involved in diverse processes, including DNA damage response36, translational37 and transcriptional38 regulation, ribosome biogenesis39, cell adhesion40, and endocytosis41. Such nano-to-micron-scale compartments have no surrounding membrane but sequester key molecules and help in cellular organization, similar to canonical organelles2,42.
...
However, abnormal phase behavior of biological condensates is speculated to underlie multiple disease states, including neurodegenerative diseases such as Huntington's5, ALS6, and Parkinson's7.
...
Conformational changes in domain resident molecules and their subsequent activity shift regulates key signaling events10,11.
It has also been observed that the HIV Gag protein is sensitive to domains with high cholesterol content, suggesting a potential role of membrane domains in host-pathogen interaction and viral assembly14.
...
Lipid domains have been studied from the perspective of phase separation experimentally and computationally. However, teasing out the complex interactions between domain components that determine the membrane organization is challenging in vivo due to the limitations of different methodologies 44. Such difficulties primarily arise due to (a) the complex composition of cell membrane15, (b) difficulties in defining domain properties in vivo8, and (c) challenges in achieving specificity when perturbing the system with probes16.

Hence simple model membranes have been extensively used to mimic the phase separation of complex cell membrane phenomenon in vitro17-19 and in silico20-22.
...
To circumvent this limitation, Coarse-Grained (CG) MD simulations have been used to study spontaneous phase separations in model membranes21,45. CG-MD is an ideal tool to study phase separation in the membrane due to its inherent advantage of high spatial and temporal resolution while capturing nanoscale domains due to transient phase separation events. Previously, the Tielman45 and the Gorfe groups20 have done some pioneering works on the thermodynamics of lipid domains.
...
Various enhanced sampling protocols have previously demonstrated their ability to enhance the sampling of rare events—for example, umbrella sampling48, metadynamics54, and path sampling techniques like weighted ensemble method26.
...
In other methods, one needs to compute the collective variable (sometimes it's derivative) on the fly as the dynamics proceeds.
Sometimes, such computations are done on single CPUs serially, leading to poor performance overall.
To track lipid bilayer phase separation, we need collective variables that project complex global dynamics of the system to lower dimensions.
