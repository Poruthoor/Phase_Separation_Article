...
maxcap=[1.95]	#for each dimension enter the maximum number at which binning can occur, if you do not wish to have a cap use inf

mincap=[0.95]  #for each dimension enter the minimum number at which binning can occur, if you do not wish to have a cap use -inf
