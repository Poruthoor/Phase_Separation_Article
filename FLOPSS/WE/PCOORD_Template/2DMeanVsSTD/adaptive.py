...
numberofdim=2  # number of dimensions : Mean and STD
...
maxcap=[275,100]	#for each dimension enter the maximum number at which binning can occur, if you do not wish to have a cap use inf
...
targetstatedirection=[1,-1]  #if your target state is meant to be greater that the starting pcoor use 1 or else use -1.This will be done for each dimension in your simulation. We are starting from left bin to right.
