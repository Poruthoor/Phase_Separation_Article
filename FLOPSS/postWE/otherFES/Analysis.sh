...
#SBATCH -t 08:00:00
#SBATCH -c 1
#SBATCH -J OtherFES_Analysis
#SBATCH -o OtherFES_Analysis_o
#SBATCH -e OtherFES_Analysis_e
        ...
        do
            ...
            do
                ...
                if [ -e /scratch/aporutho/LipidPhase/Simulation/Weighted_Ensemble_3/$P/DPPC_${i}_CHOL/$T/$d/west.h5 ] ; then
                    ...
                    mkdir -pv $CURRENT/${P}_AuxData/DPPC_${i}_CHOL/$T/0${d}

                    rsync -av /scratch/aporutho/LipidPhase/Simulation/Weighted_Ensemble_3/$P/DPPC_${i}_CHOL/$T/$d/west.h5 $CURRENT/${P}_AuxData/DPPC_${i}_CHOL/$T/0${d}

                    cd $CURRENT/${P}_AuxData/DPPC_${i}_CHOL/$T/0${d}/
